function [Filters, b, vThreshs] = optimize_filters(database_posi, database_nega, model, FPosi, params, optiParas)
...
while (nIter < maxIters & err > errTolerance & L < L_max)  
    ...
    feats_nega = randSample_nega(database_nega, Filters_curr, params, num_nega_rand, vNParts);
