function [accuracy, accu]=classification_learnedParts_multiScale_flip(FileModel, saveFolder, params, round)
trainSVMonCluster = 0;
...
if ~(skipCoding == 1)           
    ...
    %else
    %   APT_run('coding_maxResp_filters_s2f', database_para, dict, PartSize_fea_para, featDims_para ,poolPara, 'UseCluster', 1,'ClusterID', 2,  'KeepTmp', 1, 'NJobs', 50); %, 
    end
end
