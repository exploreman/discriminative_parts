...
skipTrainTestSetup = 1;

Nclusts = [100, 300, 500, 700, 900];

for round = 1 : num_rounds  
    
    params.numClusters = Nclusts(round)
    if round == 1
        skipTrainTestSetup = 0;
    else
        skipTrainTestSetup = 1;
    ...
    saveClusterCenters = [DictFolderPath_new,'ClusterCenters_', num2str(params.PartSize_fea), '_iswhtened_', num2str(iswhitening), '_nClust_', num2str(params.numClusters) ,'.mat'];
    ...
    modelfile = [DictFolderPath_new, 'LearnedParts_MSMF_', num2str(params.PartSize_fea), '_iswhtened_', num2str(iswhitening), '_Round', num2str(round) ,'_Regu_',num2str(params.lambdas),'_nClust_', num2str(params.numClusters), '.mat']
    ...
    % save the results
    resultfile = [ResultFolderPath_new, 'Results_', num2str(params.PartSize_fea), '_iswhtened_', num2str(iswhitening), '_Round', num2str(round) ,'_Regu',num2str(params.lambdas),'_nClust_', num2str(params.numClusters),'.mat']   
    accu_all{round} = accu;
